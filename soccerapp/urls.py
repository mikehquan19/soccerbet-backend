...
urlpatterns = [
    ...
    path('standings/<str:league>', views.Standings.as_view()),
    path('matches/<str:league>/<str:status>', views.MatchList.as_view()),
    path('users/<int:pk>', views.UserDetail.as_view()),

    # endpoints for the bet info
    path('match/<int:match_id>/moneyline_bet_info/<str:bet_obj>', views.MoneylineInfoList.as_view()),
    path('match/<int:match_id>/handicap_bet_info/<str:bet_obj>', views.HandicapInfoList.as_view()),
    path('match/<int:match_id>/total_bet_info/<str:bet_obj>', views.TotalObjectsInfoList.as_view()),
    ...
    path('users/<int:user_id>/total_bets', views.UserTotalGoalsBetList.as_view()),
