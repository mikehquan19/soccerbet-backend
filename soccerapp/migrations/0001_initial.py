# Generated by Django 5.1.1 on 2024-11-03 02:48
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('match_id', 'home_team'), name='unique_id_home_team')],
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('time_type', models.CharField(choices=[('full time', 'full_time'), ('half time', 'half_time')], max_length=50)),
                ('bet_team', models.CharField(max_length=150)),
                ('odd', models.DecimalField(decimal_places=2, default=0, max_digits=8)),
                ('status', models.CharField(choices=[('Unsettled', 'UN'), ('Settled', 'SE')], default='Unsettled', max_length=50)),
